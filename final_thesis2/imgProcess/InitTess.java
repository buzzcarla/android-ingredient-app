...
final class InitTess extends ImgProcessManager {
    ...
    public void copyAssets(Context ctx){
        ...
        if (files != null) for (String filename : files) {
            ...
            try {
                ...
                /*if(filename.equals("letters.txt"))
                {
                    outFile = new File(Environment.getExternalStorageDirectory().toString()+"/tessdata/config", filename);
                    Log.d("Config:","Letters Transferred");
                }*/
                //else
                    outFile = new File(Environment.getExternalStorageDirectory().toString()+"/tessdata", filename);
